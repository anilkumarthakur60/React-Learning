...
import Section6BookEdit from "./Section6BookEdit";

function Section6BookShow({book, itemKey,  onDelete, onEdit}) {
            ...
            <div className="col-3 col-sm-6   mt-4">
                <div className="card h-100 bg-light px-3 ">
                    <div className="row my-3">
                        ...
                        {
                            enableEdit?  <Section6BookEdit book={book} onEdit={onEdit} itemKey={itemKey} /> : null
                        }
                    </div>
                </div>
            </div>
...
export default Section6BookShow